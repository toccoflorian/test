...
body header .container-2 nav span a {
  padding: 50% 0;
  text-align: center;
  font-size: 0.9rem;
  color: white;
...
window.addEventListener('DOMContentLoaded', event => {
  ...
  document.addEventListener('scroll', event => {
    if (scrollY > 0) {
      ...
      contentElement.style = 'margin-top: 50px';
    }
